...
describe '#find_todo_items' do
  it 'returns a hash of todo items from a directory'do
    ...
    expected = {:directory=>"test_data", :todo_list=>[{:file=>"/testing.rb", :todos=>[{:todo=>"test1", :location=>1}, {:todo=>"test2", :location=>2}, {:todo=>" test3\n", :location=>3}, {:todo=>": test4}\n", :location=>4}, {:todo=>"test5", :location=>5}, {:todo=>"test6", :location=>6}]}]}
